package me.maxandroid.tieguanyinsimple.compiler.activity

import com.squareup.javapoet.JavaFile
import com.squareup.javapoet.TypeSpec
import com.squareup.kotlinpoet.FileSpec
import me.maxandroid.tieguanyinsimple.compiler.activity.method.*
...
class ActivityClassBuilder(private val activityClass: ActivityClass) {
    ...
    fun build(filer: Filer) {
        ...
        val typeBuilder =
            TypeSpec.classBuilder(activityClass.simpleName + POSIX).addModifiers(Modifier.PUBLIC, Modifier.FINAL)
